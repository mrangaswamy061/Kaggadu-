...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#1a1a1a] border-t border-white/5 pt-16 pb-8 overflow-hidden text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            <Link to="/" className="flex items-center gap-3">
              <div className="bg-white/10 p-2 rounded-full border border-white/5">
                <Compass className="w-6 h-6 text-orange-550" />
              </div>
              <div>
            ...
            <div className="flex items-center gap-3">
              <a href="https://www.instagram.com/kaggadu_adventures?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noreferrer" className="p-2.5 rounded-full bg-white/5 border border-white/10 hover:border-orange-500 hover:text-orange-500 transition-all duration-300 text-white/60">
              ...
              <a 
                ...
                className="p-2.5 rounded-full bg-white/5 border border-white/10 hover:border-forest-500 hover:text-forest-500 transition-all duration-300 text-white/60"
              >
            ...
            <p className="font-sans text-sm text-white/70 mt-2">Jayanagar 4th Block, Tumkur, Karnataka</p>
          </div>

          {/* Quick Links */}
          <div>
            <h4 className="font-display font-bold text-base text-white tracking-wider uppercase mb-6 flex items-center gap-2">
              <span className="w-1.5 h-3 bg-forest-500 rounded-full"></span> Quick Links
            </h4>
            <ul className="space-y-3 font-sans text-sm">
              <li>
                <button onClick={() => handleScrollTo('hero')} className="text-white/60 hover:text-orange-500 transition-colors cursor-pointer text-left">
                  Home Base
                </button>
              </li>
              <li>
                <button onClick={() => handleScrollTo('treks')} className="text-white/60 hover:text-orange-500 transition-colors cursor-pointer text-left">
                  Upcoming Expeditions
                </button>
              </li>
              <li>
                <button onClick={() => handleScrollTo('upcoming-events')} className="text-white/60 hover:text-orange-500 transition-colors cursor-pointer text-left">
                  Upcoming Events
                </button>
              </li>
              <li>
                <button onClick={() => handleScrollTo('about')} className="text-white/60 hover:text-orange-500 transition-colors cursor-pointer text-left">
                  About Community
                </button>
              </li>
            </ul>
          ...
          <div>
            <h4 className="font-display font-bold text-base text-white tracking-wider uppercase mb-6 flex items-center gap-2">
              <span className="w-1.5 h-3 bg-orange-500 rounded-full"></span> Top Trails
            </h4>
            <ul className="space-y-3 font-sans text-sm">
              <li>
                <Link to="/trek/skandagiri-sunrise" className="text-white/60 hover:text-forest-500 transition-colors flex items-center gap-2">
                  <Flame className="w-3.5 h-3.5 text-orange-500" /> Skandagiri Sunrise Trek
                </Link>
              </li>
              <li>
                <Link to="/trek/kudremukh-trek" className="text-white/60 hover:text-forest-500 transition-colors flex items-center gap-2">
                  <Flame className="w-3.5 h-3.5 text-orange-500" /> Kudremukh Peak Trek
                </Link>
              </li>
              <li>
                <Link to="/trek/kodachadri-trek" className="text-white/60 hover:text-forest-500 transition-colors flex items-center gap-2">
                  <Flame className="w-3.5 h-3.5 text-orange-500" /> Kodachadri Hill Climb
                </Link>
              </li>
              <li>
                <Link to="/trek/gokarna-beach-trek" className="text-white/60 hover:text-forest-500 transition-colors flex items-center gap-2">
          ...
          <div>
            <h4 className="font-display font-bold text-base text-white tracking-wider uppercase mb-6 flex items-center gap-2">
              <span className="w-1.5 h-3 bg-forest-500 rounded-full"></span> Adventure Rules
            </h4>
        ...
        {/* Copyright */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 font-sans text-xs text-white/40 text-center">
